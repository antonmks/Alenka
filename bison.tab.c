...
{
       6,    64,     3,     1,   -45,  -119,    34,    40,  -119,    16,
    -119,    87,    90,    79,    98,    88,  -119,   -22,    65,   -40,
    -119,  -119,  -119,  -119,  -119,  -119,    79,    79,    79,    43,
      49,    50,    51,    52,    79,   345,   -42,    78,    41,    63,
      57,    79,  -119,  -119,  -119,   123,   122,    92,   155,   155,
      79,    79,    79,    79,    79,   191,    79,    79,    79,    79,
      -4,   146,    79,    79,    79,    79,    79,    79,    79,   126,
     132,    79,    79,    75,   133,    82,   138,    81,   396,  -119,
      94,   213,   235,   257,   279,   301,  -119,   396,   416,   435,
      92,  -119,   137,    55,   162,     2,    36,    36,  -119,  -119,
    -119,  -119,  -119,   -37,   373,   145,  -119,  -119,   143,  -119,
    -119,    99,    79,    97,  -119,  -119,  -119,  -119,  -119,  -119,
       8,   102,   166,   141,   131,   157,   167,  -119,   159,   177,
      79,   144,   165,   396,   -53,   208,  -119,   156,    79,   212,
     225,   226,  -119,  -119,  -119,   161,   168,  -119,    79,   170,
      79,  -119,   178,   179,   181,  -119,    79,   396,   228,   323,
      79,    79,    79,    29,   175,  -119,   396,   396,   396,  -119,
    -119
};
...
{
    -119,  -119,   248,   160,   -13,   124,  -119,   100,  -118,  -119,
    -119,   101,   112
};
...
static const yytype_uint8 yytable[] =
{
      35,     8,    70,   122,    91,     1,   123,     7,    43,    44,
       1,   147,   144,    47,    48,    49,   148,    10,    92,     6,
     151,    55,   124,   125,   126,    45,    46,    71,    78,    39,
      ...
      11,    26,    12,    45,    46,     6,    27,    28,    16,    13,
      55,    14,    15,    19,    20,    21,    22,    23,    24,    25,
      17,    38,    73,   169,    18,    26,     2,    74,   148,   133,
      27,    28,    37,    77,    41,    29,    50,    30,    31,    32,
      33,    60,    51,    52,    53,    54,    61,    72,    34,    62,
      63,    64,    65,    66,    67,    68,    76,    79,    80,    29,
     102,    30,    31,    32,    33,   157,   103,   159,   108,   109,
     110,   111,    34,   133,   112,   119,   131,   166,   167,   168,
      19,    20,    21,    22,    23,    24,    25,    56,    57,    58,
      59,   113,    26,   132,    60,   135,   136,    27,    28,    61,
     137,   139,    62,    63,    64,    65,    66,    67,    68,    61,
     138,   143,    62,    63,    64,    65,    66,    67,    68,    62,
      63,    64,    65,    66,    67,    68,    29,   140,    30,    31,
      32,    33,   123,    56,    57,    58,    59,   141,   145,    93,
      60,   146,   149,   150,   130,    61,   152,    74,    62,    63,
      64,    65,    66,    67,    68,    56,    57,    58,    59,   153,
     154,   156,    60,   158,   164,   160,   161,    61,   162,   170,
      62,    63,    64,    65,    66,    67,    68,    56,    57,    58,
      59,     9,   142,   121,    60,    86,   163,   155,     0,    61,
     165,     0,    62,    63,    64,    65,    66,    67,    68,    56,
      57,    58,    59,     0,     0,     0,    60,   114,     0,     0,
...
static const yytype_int16 yycheck[] =
{
     ...
     138,    34,    59,    60,    61,    65,    66,    69,    41,    51,
      ...
      36,    16,    38,    65,    66,    11,    21,    22,    62,    45,
      93,    47,    42,     4,     5,     6,     7,     8,     9,    10,
       3,     3,    51,    64,     4,    16,    41,    56,    69,   112,
      21,    22,     4,    46,    39,    50,    63,    52,    53,    54,
      55,    19,    63,    63,    63,    63,    24,    39,    63,    27,
      28,    29,    30,    31,    32,    33,    63,     4,     6,    50,
       4,    52,    53,    54,    55,   148,     4,   150,    63,     6,
      58,     3,    63,   156,    63,     8,     3,   160,   161,   162,
       4,     5,     6,     7,     8,     9,    10,    12,    13,    14,
      15,    67,    16,    64,    19,    68,    64,    21,    22,    24,
       4,    40,    27,    28,    29,    30,    31,    32,    33,    24,
      39,     4,    27,    28,    29,    30,    31,    32,    33,    27,
      28,    29,    30,    31,    32,    33,    50,    40,    52,    53,
      54,    55,    43,    12,    13,    14,    15,    40,    64,    63,
      19,    46,     4,    57,    69,    24,     4,    56,    27,    28,
      29,    30,    31,    32,    33,    12,    13,    14,    15,     4,
       4,    63,    19,    63,     6,    57,    57,    24,    57,    64,
      27,    28,    29,    30,    31,    32,    33,    12,    13,    14,
      15,     3,   128,    93,    19,    64,   156,   145,    -1,    24,
     159,    -1,    27,    28,    29,    30,    31,    32,    33,    12,
      13,    14,    15,    -1,    -1,    -1,    19,    64,    -1,    -1,
...
void emit_multijoin(string s, string j1, string j2, unsigned int tab, char* res_name)
{
    ...
    queue<string> lc(cc);
    curr_segment = 10000000;	
	thrust::device_vector<unsigned int> p_tmp;	
	thrust::device_vector<unsigned int> v_l;
	if(left->prm.empty()) {          
		v_l.resize(left->maxRecs);
    }
    else {
		v_l.resize(largest_prm(left));
    };		
    ...
    for (unsigned int i = 0; i < left->segCount; i++) {
        ...
        if (cnt_l) {
            ...
            if (join_col_cnt) {
    		res_count = RelationalJoin<MgpuJoinKindInner>(thrust::raw_pointer_cast(left->d_columns_int[idx].data()), cnt_l/3,
			...
			if(res_count) {			
				...
				thrust::gather(d_res1, d_res1+res_count, v_l.begin(), p_tmp.begin());		
			};				
			...
			while(join_col_cnt) {			
                ...
                if (res_count) {
                    ...
                    if (left->type[colInd3] == 1 && right->type[colInd4]  == 1) {
						...
						thrust::permutation_iterator<ElementIterator_float,IndexIterator> iter(left->d_columns_float[left->type_index[colInd3]].begin(), p_tmp.begin());
						...
						thrust::transform(iter, iter+res_count, iter1, d_add, float_equal_to());
                    }
                    else {
                        if(right->d_columns_int[right->type_index[colInd4]].size() == 0) {
                            unsigned int cnt_r = load_queue(rc, right, 0, f4, rcount);		
			            };                        					
					    thrust::permutation_iterator<ElementIterator_int,IndexIterator> iter(left->d_columns_int[left->type_index[colInd3]].begin(), p_tmp.begin());
                        ...
                        thrust::transform(iter, iter+res_count, iter1, d_add, thrust::equal_to<int_type>());
                    };

                    new_cnt = thrust::count(d_add, d_add+res_count, 1);	
                    thrust::stable_partition(d_res1, d_res1 + res_count, d_add, thrust::identity<unsigned int>());
            ...
            if(res_count) {			
                ...
                while(!op_sel1.empty()) {
					...
					if(left->columnNames.find(op_sel1.front()) !=  left->columnNames.end()) {
                        ...
                        //gather
                        if(left->type[colInd] == 0) {
							thrust::device_ptr<int_type> d_tmp = thrust::device_malloc<int_type>(res_count*int_size);	
						    ...
						    thrust::device_ptr<float_type> d_tmp = thrust::device_malloc<float_type>(res_count*float_size);	
