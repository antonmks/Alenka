...
static const yytype_uint16 yyrline[] =
{
     ...
     247,   248,   249,   250,   252,   253,   254,   258,   259,   262,
     265,   269,   270,   271,   275,   276,   280,   281,   284,   286,
     289,   293,   294,   295,   296,   297,   298,   299,   300,   302,
     305,   307,   310,   311,   312
};
#endif
	...
	if (scan_state == 0) {		
		...
		for(int i = 0; i < left->segCount; i++) {
            ...
            /*else { //strings							
				...
				delete [] d_tmp;				
				res->compress_char(str, rcolumn, res->mRecCount, 0, i);
				check_sort(str, rtable, rid);
            };
			*/			
