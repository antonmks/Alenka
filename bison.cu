...
{
       0,   139,   139,   140,   144,   147,   149,   151,   153,   155,
     157,   159,   161,   163,   165,   170,   171,   172,   173,   174,
     175,   176,   177,   178,   179,   180,   181,   182,   183,   184,
     185,   186,   190,   191,   192,   193,   194,   195,   197,   198,
     199,   200,   201,   202,   203,   204,   206,   207,   211,   212,
     215,   218,   222,   223,   227,   228,   232,   233,   236,   238,
     241,   244,   245,   247,   250
};
#endif
...
//			std::cout<< "select time1 " <<  ( ( std::clock() - start1 ) / (double)CLOCKS_PER_SEC ) <<'\n';		
            add(c,b,op_v3, op_v2);
        };
        b->deAllocOnDevice();
    };	
